...
COPY frps.ini ./frp_${VERSION}_linux_arm64/frp/frps.ini
...
```sh
docker run --restart=always --network host -p 443:443 -p 7000:7000 -p 7001:7001 -p 7500:7500 -p 80:80 -p 9000:9000 -p 9001:9001 -d --name frps whl401765060/frps:0.36.2
```
